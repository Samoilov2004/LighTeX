...
<h1 align="center">LighTex 1.1.8</h1>
...
[View LighTex 1.1.8 and its checksums](https://github.com/Samoilov2004/LighTeX/releases/tag/v1.1.8)
...
- Files, Search, and Table of Contents navigation with PDF page numbers plus safe rename, duplicate, move, upload, and Trash operations.
- Compact Insert Shelf with searchable symbols, readable formula previews, reusable blocks and one-click table sizing.
...
- A focused template creator with real PDF previews, configurable Course Notes title pages, single-file or chapter-folder layouts, code styles, and two section-numbering modes.
